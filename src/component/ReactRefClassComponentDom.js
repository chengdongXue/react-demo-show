    ...
    render(){
        ...
        return (
            <div>
                ...
                <input type="text" name="userName" id="userName" value={this.state.userName} ref={this.userNameRef}></input>
                <input type="button" name="registerUserName" value="Register User Name" onClick={this.registerUserName}></input>
            </div>
        )
    }
}
